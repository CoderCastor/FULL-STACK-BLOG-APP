  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen bg-[#b9e7e7]'>
        ...
        <form action="" className='flex flex-col p-10 bg-white w-1/4 h-2/7 gap-[20px]'>
            <input className='p-[10px] border-b-gray-900' type="text" placeholder='username' name="" id="" />
            <input className='p-[10px] border-none border-r' type="password" placeholder='password' name="" id="" />
